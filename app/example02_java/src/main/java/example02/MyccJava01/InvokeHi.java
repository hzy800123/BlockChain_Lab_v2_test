...
public class InvokeHi {
    ...
    private static void doHi(String orgName, String userName, String functionName)
        ...
        try (Gateway gateway = builder.connect()) {
            ...
            System.out.println("Hi - " + new String(result) + "\n");
        }
    }

    public static void main(String[] args) {
        try {
            doHi(ORGNAME_ORG1, USERNAME_ORG1, "Hi");
