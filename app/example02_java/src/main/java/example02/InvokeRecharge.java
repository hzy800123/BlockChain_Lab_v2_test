...
public class InvokeRecharge {
    ...
    private static void doInit(String orgName, String userName, String functionName, String key, String rechargeAmount) throws IOException, ContractException, TimeoutException, InterruptedException {
    ...
    public static void main(String[] args) {
        try {
            doInit(ORGNAME_ORG1, USERNAME_ORG1, "Recharge", "a", "5");
